...
import { StyleSheet,TouchableOpacity, View, Text,TextInput ,ScrollView,ImageBackground, Image, AsyncStorage} from 'react-native';
...
>
      <View style={styles.container}>
        ...
        <View style={{flex:5,alignItems:'center',justifyContent:'flex-end'}}>
           ...
           <TouchableOpacity style = {styles.btn} onPress={()=>this.setState({isDialogVisible:true})}>
            <Text style={styles.txt}>Add Job</Text>
        </TouchableOpacity>


        <TouchableOpacity style = {styles.btn} onPress={()=>this.props.navigation.navigate('ResponsiveTable')}>
            <Text style={styles.txt}>Create Table</Text>
        </TouchableOpacity>
